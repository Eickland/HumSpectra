...
def md_error_map(
    ...
    dif_masses = gen_from_brutto(df)['calc_mass'].to_numpy()
...
def assign_error(
    ...
    spectr = assign_optimized(spectr,rel_error=ppm, brutto_dict=brutto_dict, sign=mode)
...
def assign_tmds(
    ...
    res = drop_unassigned(assign_optimized(self,generated_bruttos_table=generated_bruttos_table, abs_error=error, sign='0'))
